#!/home/prtc/anaconda3/bin/python
...
hdr_fmt = '80s B3x 3I Q B7x d d q q B B B1x H2x Q Q Q B1x H4x' # aligned style
...
#        self.mtdata['imname'] = self.mtdata['imname'].strip('\x00')
        ...
        cnt = self.print_meta_data(verbose)
        return cnt
    ...
    def print_meta_data(self, verbose=True):
        ''' --------------------------------------------------------------
