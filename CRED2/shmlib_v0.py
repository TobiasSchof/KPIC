...
#DEFLAG: v0 was before I fixed the keyword writing problems
...
class shm:
    ...
    def read_meta_data(self, verbose=True):
        ...
        #DEFLAG: decoded to string from byte
        self.mtdata['imname'] = self.mtdata['imname'].decode("utf-8").strip('\x00')
    ...
    def read_keyword(self, ii):
        ...
        if kwfmt == '16s 80s':
            kval = str(kval.decode()).strip('\x00') #DEFLAG: decode to string...
