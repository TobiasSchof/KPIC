...
class Filter_Wh_cmds:
    """Class for controlling the filter wheel rotator via shared memory
    ...
    def __init__(self):
        """Constructor for Filter_Wh_cmds"""

        # the config file has all the info needed to connect to shared memory
        config = ConfigParser()
        config.read(RELDIR+"/data/Filter_Wh.ini")
    ...
    def is_Active(self) -> bool:
        ...
        Returns:
            bool = whether the Filter_Wh control script is active
        """
    ...
    def is_Connected(self) -> bool:
        ...
        Returns:
            bool = whether the Filter_Wh is active
        """
    ...
    def is_Homed(self) -> bool:
        ...
        Returns:
            bool = whether the Filter_Wh is in a referenced state
        """
    ...
    def get_pos(self, update:bool=True, time:bool=False) -> float:
        """Return the current position of the Filter_Wh
    ...
    def set_pos(self, target, block:bool=False):
        ...
        Args:
            target = float: the position for the Filter_Wh to move to
                    or
