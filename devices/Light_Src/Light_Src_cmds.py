...
class Light_Src_cmds:
    ...
    def __init__(self):
        """Constructor for Light_Src_cmds"""

        # the config file has all the info needed to connect to shared memory
        config = ConfigParser()
        config.read(RELDIR+"/data/Light_Src.ini")
    ...
    def is_Active(self) -> bool:
        ...
        Returns:
            bool = whether the Light_Src control script is active
        """
    ...
    def is_Connected(self) -> bool:
        ...
        Returns:
            bool = whether the Light_Src is active
        """
    ...
    def is_Homed(self) -> bool:
        ...
        Returns:
            bool = whether the Light_Src is in a referenced state
        """
    ...
    def get_pos(self, update:bool=True, time:bool=False) -> float:
        """Return the current position of the Light_Src
    ...
    def set_pos(self, target, block:bool=False):
        ...
        Args:
            target = float: the position for the Light_Src to move to
                    or
